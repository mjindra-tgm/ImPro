  ...
  render(){
    ...
    return(
      <div className = "col-s-12 col-m-4 col-4">
        {players&&<Playerlist parentCss="col-s-12 col-m-12 col-12" team={self.team} name="Spieler" leaders={Object.values(game.leaders)} players={players} childCss={this.props.gamemode + "Border desc"}></Playerlist>}
