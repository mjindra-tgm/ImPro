...
class App extends React.Component<{},AppState> {
    ...
    createRoom(gamemode) {
        ...
        Meteor.call(
            "rooms.create",
            { playerId: this.userSession(), name: this.state.name, gamemode: gamemode, settings: settings, propabilities: propabilities },
            (e, id) => {
                if (e) {
        ...
        switch (this.state.mode) {
                    ...
                    <div className="overlay">
                        <div className="overlaytext">
                            ...
                            <button
                                ...
                                onClick={() => {
                                    this.setState({ mode: "createSettings" });
                                }}
                            >
                                Diskussion
                            </button>
                ...
                content = (
                    <div className="overlay">
                        <div className="overlaytext">
                            ...
                            {/* Teams mischen */}
                            <div className="loginCheckboxParent toggle">
                                {" "}
                                Teams durchmischen{" "}
                                <input
                                    defaultChecked={this.state.mixTeams}
                                    id="mixTeams"
                                    type="checkbox"
                                    value="mixTeams"
                                    onChange={(e) => {
                                        this.setState({ mixTeams: e.target.checked });
                                    }}
                                ></input>
                                <label htmlFor="mixTeams">Toggle</label>
                            </div>
                            {/* Rundeneinstellungen */}
                            <div className="loginCheckboxParent toggle">
                                {" "}
                                Runden automatische ermitteln{" "}
                                <input
                                    defaultChecked={true}
                                    id="autoRounds"
                                    type="checkbox"
                                    value="autoRounds"
                                    onChange={(e) => {
                                        this.setState({ rounds: e.target.checked ? 0 : 1 });
                                    }}
                                ></input>
                                <label htmlFor="autoRounds">Toggle</label>
                            </div>
                            {this.state.rounds > 0 && (
                                <div className="loginSliderParent">
                                    {" "}
                                    <input
                                        type="range"
                                        className="slider"
                                    ...
                                    <div className="bubbleParent">
                                        <div className="sliderBubble" style={{ left: ((this.state.rounds - 1) / 14) * 100 + "%" }}>
                                            {this.state.rounds}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="loginCheckboxParent toggle">
                                ...
                                <input
                                    ...
                                    value="manualProbs"
                                    onChange={(e) => {
                                        this.setState({ manualProbs: e.target.checked });
                                    }}
                                ></input>
                                <label htmlFor="manualProbs">Toggle</label>
                            </div>
            ...
            case "join":
                content = (
                    <div className="overlay">
                        <div className="overlaytext">
                            <div className="overlayheader">Room:</div>{" "}
                            <input
            ...
            return (
                <>
                    ...
                    >
                        {" "}
                        <input
                            defaultValue={this.state[i.name]}
                            type="range"
                            className="slider"
                            min="0"
                            max="5"
